...
# set :repo_url,        'https://your-account:your_passowrd@bitbucket.org/your-account/shop.git'
set :repo_url,        'git@github.com:baonguyen1320/shop_app.git'
# set :repo_url,        'https://github.com/baonguyen1320/shop_app'
set :application,     'shop_app'
